...
# x = 0
# for i in range(32):
# x = x*256+random.randint(256)
x = 25820673207460920161927504461029808589475914164786777366982424479333501272580
print("Randint = {}".format(x))
print("randint as array = ")
print_a_with_b_words_of_length_c(x, 32, 8)

print("x**2 as array = ")
print_a_with_b_words_of_length_c(x**2, 64, 8)
